...
*/
function augustash_profile_modules() {
...
*/
function augustash_profile_details() {
  return array(
    'name' => 'August Ash',
 ...
 *   task list.
 */
function augustash_profile_task_list() {
}
 ...
 */
function augustash_profile_tasks(&$task, $url) {
...
function system_form_install_select_profile_form_alter(&$form, $form_state) {
  foreach($form['profile'] as $key => $element) {
    $form['profile'][$key]['#value'] = 'augustash';
  }
}
